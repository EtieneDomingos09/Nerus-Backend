...
from app.api.v1.endpoints import auth, user, problemas, solucoes, ranking
...
# api_router.include_router(empresas.router, prefix="/empresas", tags=["Empresas"])  # TODO: Implementar
